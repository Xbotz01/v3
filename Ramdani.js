...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉`,"description": "𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*JAM* : ${moment().utcOffset('+0700').format('HH:mm:ss')}
...
👑 *Creator : JEX NY*
🤖 *Bot Name : XYNOS BOTZ*
📌 *Nomor :* wa.me/6281578301106
👤 *Owner : JEX NY*
⏳ *Aktif : ${runtime(process.uptime())}*
📍 *Prefix : 『 MULTI PREFIX 』*
🔋 *Baterai : ${baterai}*
⏰ *Pukul : ${moment().utcOffset('+0700').format('HH:mm:ss')}*
📆 *Tanggal : ${moment.tz('Asia/Jakarta').format('DD-MMMM-YYYY')}*
🌍 *Hit All : ${hit_today.length}*
💬 *Personal Chat : ${totalchat.length}*
...
🛡 *Run* : RDP
   ...
   *《 INFO USER 》*
ℜ⃟🐣 ‣  *Nama : ${pushname}*
ℜ⃟🐣 ‣  *Nomor : @${sender.split('@')[0]}*
ℜ⃟🐣 ‣  *Status : ${isOwner ? 'OWNER' : isPremium ? 'Premium' : 'Gratisan'}*
ℜ⃟🐣 ‣  *Baterai : ${baterai}*
    ...
    *《 JOIN GRUP BOT 》*
Group 1 : 
https://chat.whatsapp.com/L4qMEQjCZHABsUnRL8ZD9F
...
`
               buttons = [{buttonId: `${prefix}allmenu`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}command`,buttonText:{displayText: 'MENU SIMPEL'},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: 'OWNER'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '_𝚁𝙴𝙶𝙰𝚁𝙳𝚂 : 𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉_', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
ℜ⃟🐣 ‣ NAMA : *${pushname}*
ℜ⃟🐣 ‣ API : *@${sender.split('@')[0]}*
ℜ⃟🐣 ‣ STATUS : *${isOwner ? 'OWNER' : isPremium ? 'Premium' : 'Gratisan'}*
ℜ⃟🐣 ‣ LIMIT : *${isPremium ? 'Unlimited' : `${gcount}`}*
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               buttonsMessage = {
               contentText: `${man}`,
               footerText: '_𝚁𝙴𝙶𝙰𝚁𝙳𝚂 : 𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
        ...
        case 'command':
               list = []
               listmenu = [`soundmenu`,`selamat`,`groupmenu`,`wibumenu`,`stickermenu`,`islammenu`,`sertimenu`,`ceritamenu`,`makermenu`,`dewasamenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`toolsmenu`,`infobot`,`owner`,`buttonstik`,`buttondl`,`buttosound`,`buttonown`,`buttonpen`,`buttongame`,`buttongc`]
               listmenuu = [`Sound Menu`,`Tahun Baru`,`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Dewasa Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`MenuLainnya`,`Tools Menu`,`Info Bot`,`Owner`,`Stiker Menu`,`Dowload Menu`,`Owner Menu`,`Nulis Menu`,`Game Menu`,`Grup Menu`]
               nombor = 1
               startnum = 0
...
case 'tiktok':
              ...
              imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani3.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani3.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Follow IG OWNER\n Helpme tu 10k Followers', imageMessage: imageMsg,
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCVj5aSi1hIH9eCeGT6YyXDg`)
              break
case 'y':
reply ('Y')
break
...
//------------------< Lainnya >-------------------
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
               thankslort = `━━━━━ *INFO BOT* ━━━━━\n➤ *BOT INI MENGGUNAKAN SCRIPT BOT DARI YT XYNOS BOTZ, JIKA INGIN MENDAPATKAN SC INI, TEKAN LINK DI BAWAH INI!!!*\n➤ *LINK YT XYNOS BOTZ : https://youtube.com/channel/UCVj5aSi1hIH9eCeGT6YyXDg*\n➤ *RUN BOT : TERMUX*\n➤ *TIPE : NODE JS*\n➤ *BASE : 𝚇𝚈𝙽𝙾𝚂 𝙱𝙾𝚃𝚉*\n*━━━━━━━━━━━━━━━━━━━━*`
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('6281578301106@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
      ...
      case 'qris':      
        qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
              ...
              Ramdani.relayWAMessage(prep)
                ...
                break
      case 'dana':
             reply(`DANA : 0895402219643`)
             break
           case 'gopay':
             reply(`*Gopay :* 0895402219642`)
             break  
         case 'pulsa':
             reply(`*Pulsa :* 081578301106`)
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/pamelingrintiswiji13`)
             break
      case 'grupbot':
...
│❏  PERMANEN : IDR 12.000 (12K)
│❏  GC STORE : IDR 6.000 (6K)
╰────
╭─ [ KELEBIHAN BOT ]
│❏  ＯＮ 24 ＪＡＭ
│❏  WELCOME IMAGE
...
╰────
╭─[ *MINAT CHAT* ]
│❏  🪀 wa.me/6281578301106?text=sewa+bot
╰────
╭─[ *TES BOT? MASUK GRUB DI BAWAH* ]
│❏ https://bit.ly/3ruGKhW
╰────
╭─[ *PAYMENT* ]
│❏  GOPAY
│❏  DANA
